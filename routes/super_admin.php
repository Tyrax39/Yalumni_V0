...
Route::group(['prefix' => 'setting', 'as' => 'setting.'], function () {
    ...
    if (isAddonInstalled('ALUSAAS')) {
        Route::group(['prefix' => 'currency', 'as' => 'currencies.'], function () {
            Route::get('', [\App\Http\Controllers\addon\saas\super_admin\CurrencyController::class, 'index'])->name('index');
            Route::post('currency', [\App\Http\Controllers\addon\saas\super_admin\CurrencyController::class, 'store'])->name('store');
            Route::get('edit/{id}', [\App\Http\Controllers\addon\saas\super_admin\CurrencyController::class, 'edit'])->name('edit');
            Route::patch('update/{id}', [\App\Http\Controllers\addon\saas\super_admin\CurrencyController::class, 'update'])->name('update');
            Route::post('delete/{id}', [\App\Http\Controllers\addon\saas\super_admin\CurrencyController::class, 'delete'])->name('delete');
        });

        Route::group(['prefix' => 'gateway', 'as' => 'gateway.'], function () {
            Route::get('/', [\App\Http\Controllers\addon\saas\super_admin\GatewayController::class, 'index'])->name('index');
            Route::post('store', [\App\Http\Controllers\addon\saas\super_admin\GatewayController::class, 'store'])->name('store')->middleware('isDemo');
            Route::get('get-info', [\App\Http\Controllers\addon\saas\super_admin\GatewayController::class, 'getInfo'])->name('get.info');
            Route::get('get-currency-by-gateway', [\App\Http\Controllers\addon\saas\super_admin\GatewayController::class, 'getCurrencyByGateway'])->name('get.currency');
            Route::get('syncs', [\App\Http\Controllers\addon\saas\super_admin\GatewayController::class, 'syncs'])->name('syncs');
        });

        Route::get('email-template', [\App\Http\Controllers\addon\saas\super_admin\EmailTemplateController::class, 'emailTemplate'])->name('email-template');
        Route::get('email-template-config', [\App\Http\Controllers\addon\saas\super_admin\EmailTemplateController::class, 'emailTemplateConfig'])->name('email.template.config');
        Route::post('email-template-config-update', [\App\Http\Controllers\addon\saas\super_admin\EmailTemplateController::class, 'emailTemplateConfigUpdate'])->name('email.template.config.update');
    }
